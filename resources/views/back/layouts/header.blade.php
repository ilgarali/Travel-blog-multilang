...
<div class="menu-sidebar__content js-scrollbar1">
    <nav class="navbar-sidebar">
        <ul class="list-unstyled navbar__list">
            <li class="has-sub">
                <a class="js-arrow" href="{{route('admin.dashboard')}}">
                        <i class="fas fa-tachometer-alt"></i>{{__('texts.dashboard')}}</a>
                  
            </li>
            <li class="has-sub">
                <a class="js-arrow" href="{{route('admin.category.index')}}">
            <i class="fas fa-tachometer-alt"></i>{{__('texts.categories')}}</a>
                  
            </li>
            <li class="has-sub">
                <a class="js-arrow" href="{{route('admin.post.index')}}">
            <i class="fas fa-tachometer-alt"></i>{{__('texts.posts')}}</a>
                  
            </li>
            <li class="has-sub">
                <a class="js-arrow" href="{{route('admin.contact')}}">
            <i class="fas fa-tachometer-alt"></i>{{__('texts.contact')}}</a>
                  
            </li>
            <li class="has-sub">
                <a class="js-arrow" href="{{route('admin.comment')}}">
            <i class="fas fa-tachometer-alt"></i>{{__('texts.comments')}}</a>
        ...
        <div class="container-fluid">
            <div class="header-wrap">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a  class="nav-link" href="{{ url('locale/az') }}" ><i class="fa fa-language"></i> AZ</a></li>
        </ul>
